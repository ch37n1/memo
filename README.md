...
**Status:** In implementation. Phases 0-1 are complete; Stream A1 (`memod` database layer), Stream B1 (`memo-client`), and Stream B2 (`memo` CLI scaffolding + daemon commands) are complete.
